...
function Admin() {
  ...
  const fetchAdmins = async () => {
    try {
      const response = await axios.get('https://m4u-snowy.vercel.app/admin/admins');
  ...
  const handleAddAdmin = async () => {
    try {
      const response = await axios.post('https://m4u-snowy.vercel.app/admin/register', { username });
  ...
  const handleDeleteAdmin = async (username) => {
    try {
      await axios.delete(`https://m4u-snowy.vercel.app/admin/delete/${username}`);
      fetchAdmins(); 
    } catch (error) {
